...
function checkemail(email)
{
    ...
    else
    {
        ...
        document.getElementById('email_error').innerText='Email must be include @gmail and 8 letters long '
...
function checkpassword(password)
{
    ...
    else
    {
        ...
        document.getElementById('password_error').innerText='Password must be 8 letters long and should include 8 letters'
